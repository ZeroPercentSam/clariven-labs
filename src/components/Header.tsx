    ...
    children: [
      {
        label: "Academic Labs",
        href: "/clinics",
        description: "University & academic research laboratories",
        icon: FlaskConical,
      },
      {
        label: "Biotech & Industry",
        href: "/pharmacies",
        description: "Biotech, pharma R&D & contract research orgs",
        icon: Building2,
      },
      {
        label: "Research Institutions",
        href: "/research",
        description: "Government, nonprofit & private research institutes",
        icon: FlaskConical,
      },
      {
        label: "Enterprise",
        href: "/enterprise",
        description: "High-volume procurement & institutional accounts",
        icon: Landmark,
      },
    ],
  },
