...
export const products: Product[] = [
  // Weight Management
  { id: "single-regulator", name: "Single Regulator (SIA-31-C18)", slug: "single-regulator", category: "weight-management", strengths: ["10 mg"], description: "Single-pathway metabolic regulator (GLP-1 receptor agonist) for metabolic research and weight-management studies.", benefits: ["Metabolic regulation", "Appetite modulation", "Glycemic control"], purity: "≥98%", form: "Lyophilized Powder", storage: "2-8°C" },
  { id: "triple-regulator", name: "Triple Regulator (TIA-39-C20)", slug: "triple-regulator", category: "weight-management", strengths: ["10 mg", "20 mg", "30 mg"], description: "Triple-pathway metabolic regulator targeting GLP-1, GIP, and glucagon receptors.", benefits: ["Multi-receptor targeting", "Advanced metabolic research", "Next-generation metabolic studies"], purity: "≥98%", form: "Lyophilized Powder", storage: "2-8°C" },
  { id: "dual-regulator", name: "Dual Regulator (DIA-39-C20)", slug: "dual-regulator", category: "weight-management", strengths: ["10 mg", "20 mg", "30 mg"], description: "Dual-pathway metabolic regulator (GLP-1 / glucagon receptor agonist) for advanced metabolic research.", benefits: ["Dual receptor targeting", "Liver health research", "Metabolic studies"], purity: "≥98%", form: "Lyophilized Powder", storage: "2-8°C" },
